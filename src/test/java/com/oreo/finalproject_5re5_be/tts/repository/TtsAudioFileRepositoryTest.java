...
public class TtsAudioFileRepositoryTest {
    ...
    public void createEntireData() {
        ...
        TtsAudioFile createTtsAudioFile = TtsAudioFile.builder()
        ...
        // then
        // 3. 생성된 객체 조회 및 검증
        Optional<TtsAudioFile> optionalTtsAudioFile = ttsAudioFileRepository.findById(savedTtsAudioFileTtsAudioSeq);
    ...
    public void createPartialDataWithOnlyRequired () {
        ...
        TtsAudioFile createTtsAudioFile = TtsAudioFile.builder()
                .audioName("testAudio2")
                .audioPath("testUrl2.com")
                .build();
    ...
    public void updateAllData () {
        ...
        TtsAudioFile updateTtsAudioFile = TtsAudioFile.builder()
    ...
    public void updatePartialDataWithoutRequired () {
        ...
        // when
        // 3. TtsAudioFile 객체 수정
        TtsAudioFile updateTtsAudioFile = createTtsAudioFile.toBuilder()
                .ttsAudioSeq(savedTtsAudioFileTtsAudioSeq)
                .audioExtension(updateAudioExtension)
                .audioSize(updateAudioSize)
                .audioTime(updateAudioTime)
    ...
    public void deleteData () {
        ...
        // 3. 저장 객체 조회 및 검증
        Optional<TtsAudioFile> optionalResearchedTtsAudioFile = ttsAudioFileRepository.findById(savedTtsAudioFileTtsAudioSeq);
