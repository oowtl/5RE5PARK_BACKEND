...
class TtsProcessHistoryRepositoryTest {
    ...
    * */
    ...
    public void saveTtsProcessHistory() {
        ...
        Optional<TtsProcessHistory> selectedTtsProcessHistory = ttsProcessHistoryRepository.findById(savedSeq);
    ...
    public void saveTtsProcessHistoryWithoutRequired() {
        ...
        assertThrows(DataIntegrityViolationException.class, () ->ttsProcessHistoryRepository.save(ttsProcessHistory));
    }
    ...
    public void selectTtsProcessHistory() {
        ...
        TtsProcessHistory ttsProcessHistory = createTtsProcessHistory(savedVoice, savedProject, savedTtsAudiofile, 0);
    ...
    public void selectTtsProcessHistoryList() {
        ...
        for(int i=0; i<cnt; i++) {
            ...
            // 생성
            TtsProcessHistory ttsProcessHistory = createTtsProcessHistory(savedVoice, savedProject, savedTtsAudiofile, i);
    ...
    private TtsProcessHistory createTtsProcessHistory(Voice voice, Project project, TtsAudioFile ttsAudioFile, int n) {
