...
public class VoiceRepositoryFindTest {
    ...
    public void voicefindByLangAndStyleTest() {
        ...
        List<Voice> findVoiceList = voiceRepository.findAllByLanguageAndStyleAndEnabled(savedLanguage1, savedStyle1, 'y');
        assertEquals(findVoiceList.size(), 1);
        assertEquals(findVoiceList.get(0), savedVoiceList.get(0));

        // 언어2, 스타일2 을 만족하는 결과 리스트 검증
        findVoiceList = voiceRepository.findAllByLanguageAndStyleAndEnabled(savedLanguage2, savedStyle2, 'y');
    ...
    public void voicefindByLangAndStyleTest_invalidLang() {
        ...
        invalidLanguage.toBuilder()
                .langSeq(invalidLang).build();
        ...
        assertThrows(InvalidDataAccessApiUsageException.class, ()-> voiceRepository.findAllByLanguageAndStyleAndEnabled(invalidLanguage, savedStyle, 'y'));
    }
    ...
    public void voicefindByLangAndStyleTest_invalidStyle() {
        ...
        invalidStyle.toBuilder()
                .styleSeq(invalidId).build();
