...
public class ConcatController {
    ...
    @PostMapping("")
    public ResponseEntity<ResponseDto<List<ConcatResultDto>>> concat(@RequestBody ConcatRowRequestDto audioRequests,
                                                                     @AuthenticationPrincipal CustomUserDetails customUserDetails) throws IOException, ExecutionException, InterruptedException {
        ...
        List<ConcatResultDto> concatResult = lambdaConcatService.concatOnLambda(concatTabResponseDto, audioRequests);
